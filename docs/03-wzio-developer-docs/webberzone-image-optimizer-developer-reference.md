...
tags: [webberzone-image-optimizer, developer, hooks, filters]
status: publish
order: 0
---
...
- [Classes](https://webberzone.dev/webberzone-image-optimizer/#classes) — every class in the `WebberZone\Image_Optimizer` namespace, with its public methods.
