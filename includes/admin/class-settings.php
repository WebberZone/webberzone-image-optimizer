...
class Settings {
	...
	public static function settings_quality() {
		$settings = array(
			...
			'effort'         => array(
				'id'      => 'effort',
				'name'    => esc_html__( 'Encoder effort', 'webberzone-image-optimizer' ),
	...
	public function get_help_sidebar() {
		$help_sidebar =
			...
			'<p><a href="https://github.com/WebberZone/webberzone-image-optimizer" target="_blank" rel="noopener noreferrer">' . esc_html__( 'Plugin Homepage', 'webberzone-image-optimizer' ) . '</a></p>' .
